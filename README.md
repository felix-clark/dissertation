...
The spacetime dimensions of the particle source in proton-lead collisions at $\sqrt{s_\textrm{NN}} = 5.02$ TeV is measured with the ATLAS detector at the Large Hadron Collider.
...
The measured source sizes are substantially larger in more central collisions and are observed to decrease with increasing pair $k_\textrm{T}$.
...
The HBT radii are also shown for central events in intervals of azimuthal angle relative to the 2nd-order event plane, pair transverse momentum, \kt, and flow vector magnitude, $|q_2|$, where the correlation functions are corrected for the event plane resolution.
Significant modulations of the transverse HBT radii $R_\textrm{out}$, $R_\textrm{side}$, and $R_\textrm{os}$ are observed.
...
The sign and $k_\mathrm{T}$ dependence of these modulations are consistent with a hydrodynamic evolution of a short-lived medium.
