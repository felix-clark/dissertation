...
The experimentally measured Fourier components of the particle production in \AA collisions is consistent with hydrodynamic evolution of a fluid with a small specific viscosity, described by accelerations in the direction of the negative gradient of the fluid pressure. %% $-\nabla p$.
...
%% cite previous femtoscopic results

%%e this thesis will argue that the collectivity in central \pPb has specific features that suggest hydro -- it's not clear in low multiplicity.

%% \cite{HION-2015-11,ATLAS-CONF-2017-008} %% need updated reference for azimuthal results
