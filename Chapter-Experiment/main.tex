...
\Cref{eq:lumi} shows that the keys to increasing the efficiency of data-taking are to make highly-populated bunches cross at high frequency, with low-emittance beams and optics that minimize the amplitude functions at the interaction point.
...
The extensive trigger and data acquisition system is also crucial for successful operation. %% MBTS?
%% forward detectors? ZDC?
