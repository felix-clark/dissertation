...
The Level-1 trigger is a low-level hardware system that makes rapid determinations based on activity in the calorimeters, MBTS, ZDC, and muon spectrometers.

\cite{ATLAS:1998ad} %% low-level (``first''?) . yes: level-1 trigger
\cite{ATLAS:2003aa} %% high-level trigger and DAQ
\cite{Aad:2012xs} %% performance
