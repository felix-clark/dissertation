...
Two superconducting magnet systems are used to generate a large magnetic field with field lines parallel to the beam axis \cite{ATLAS:1997ae}. %% tech design report
...
A large solenoid surrounds the inner detector and produces a 2 T magnetic field.
...

\subsection{Inner detector}
\label{subsec:atlas_id}

\cite{ATLAS:1997ag,ATLAS:1997af} %% technical design report
\cite{Aad:2010bx} %% commissioning & calibration
...
\cite{Abat:2008zza} %% TRT drift tube
