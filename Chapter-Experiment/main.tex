...
\begin{figure}[t]
 %% https://www.mpoweruk.com/figs/cyclotron.htm
  ...
  \label{fig:cyclotron}
\end{figure}
The cyclotron is another important fundamental progression in accelerator technology.
...
Sophisticated \mc simulations, which use detailed models of the nuclear interactions, are required to accurately describe the physics of hadronic calorimeters.
