...
The three \pid selections used in this analysis are the same as those in \Ref{\cite{HION-2015-11}}.
...
The Loose and Middle cut level definitions include an additional cut on $dE/dx$, as illustrated in \Cref{fig:dedx}.
...
The purity of pairs (i.e. fraction of pairs in which \emph{both} particles are pions) is shown in \Cref{fig:pid_purity_kt_eta}.
