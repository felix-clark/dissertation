...
The offline tracking cuts are those used in the \pPb multiplicity analysis \cite{HION-2012-15}, which is based on the \pp \minbias spectra analysis \cite{STDM-2010-06} with some additional cuts on impact parameter ($d_0$ and $z_0$) significance.
...
\cite{Gyulassy:1994ew} %% hijing
\cite{Agostinelli:2002hh} %% GEANT
