...
\subsection{Choice of 3D jet background form}
...
\end{minipage}
\caption{The core fraction $x_c$ measured in \Pythia 8 by counting the pairs in which neither particle is a product of a weak decay or of a $\eta$, $\eta'$, $\omega$, or $K*$.}
\label{fig:pythia_xc}
\end{figure}
