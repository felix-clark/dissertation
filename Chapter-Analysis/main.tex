...
\item \Hijing p+Pb \cite{Gyulassy:1994ew}\\
  ...
  The minimum hard-scattering \pt parameter\footnote{HIPR18} is adjusted to show that the non-femtoscopic background originates from minijets, as described in Figure \ref{fig:hard_process_min_pt}.
