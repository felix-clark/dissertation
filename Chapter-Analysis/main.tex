...
\begin{equation} \label{eq:corr_deff}
  C\left(\mathbf{p}^a, \mathbf{p}^b; \kt, \kphi\right) \equiv \dfrac{\left(\dfrac{dN^{ab}}{d^3\mathbf{p}^a d^3\mathbf{p}^b}\right)}{\left(\dfrac{dN^{a}}{d^3\mathbf{p}^a}\right)\left(\dfrac{dN^{b}}{d^3\mathbf{p}^b}\right)} \,,
\end{equation}
