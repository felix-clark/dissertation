...
%% possibly flesh this section out more?
...
\cite{Kolb:2003dz} %% claim that decrease w/ kT is collective expansion


\subsection{Motivation for femtoscopy in proton-lead}

%% \subsection{Existing experimental results for HBT radii} %% maybe not?
\todo{show plots of azimuthal HBT radii in \AA}
...
\todo{describe specific motivation for these measurements}
