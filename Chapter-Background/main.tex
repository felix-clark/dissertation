...
%% TODO: possible sections to add (time permitting): high-temp thermal field theory, detail on lattice gauge theory
...
To leading order, the \ac{pQCD} shear viscosity is \cite{Arnold:2000dr}
\begin{equation}
