...
The Glauber \mc model gives some shadowing of the total nucleus-nucleus cross section relative to the optical approach, but differences in the expected \Ncoll and \Npart are negligible \cite{Miller:2007ri}. %% todo: show figure 5 from this reference here?

In experiments, impact parameter cannot be measured directly so a proxy must be used.
...
Results presented in this thesis will provide additional support for $\omega_\sigma > 0$.
...
With a toy \ac{EoS} $p = c_s^2 \varepsilon$ the Euler equation is written %% conformal if c_s^2 = 1/3
\begin{equation}
