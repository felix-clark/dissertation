...
\begin{equation}
  \frac{\eta}{(\varepsilon + p)L} = \frac{\lambda_\textrm{mfp}}{L} \ll 1
\end{equation}
where $\lambda_\textrm{mfp}$ is the mean free path. %% eta/(ep+p) from arxiv:1712.05815 \cite{Romatschke:2017ejr} pg. 28
This condition is often expressed in terms of the Knudsen number, defined as $\textrm{Kn} \equiv \frac{\lambda_\textrm{mfp}}{L}$.
