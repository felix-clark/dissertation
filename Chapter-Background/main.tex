...
\todo{section on commonly-used quantities, rapidity, \pt, \Npart, etc. possibly at end of intro chapter. dimensionless units, $c = hbar = k_B = 1$ although sometimes left in. time-positive metric $g_{\mu\nu} = \mathrm{diag}\left( 1, -1, -1, -1\right)$}
...
\begin{figure}[t]
  ...
  \caption{Figure from \Ref{\cite{Lisa:2005dd}}.}
  \label{fig:hbt_flow}
\end{figure}
