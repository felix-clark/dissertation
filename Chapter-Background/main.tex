...
\subsection{Thermodynamics review}
...
With $s = \pm1$ for bosons/fermions this gives a probability per unit volume of
\begin{equation}
\frac{g E^2}{2\pi^2} \frac{1}{e^{E/T} - s}
\end{equation}
