...
In experiments it turns out to have a value around
\[
\lqcd \approx 200 \MeV \;,
\]
but the precise value can differ by a factor of 2 or more depending on a number of technical details.
...
\subsection{Asymptotic freedom} %% subsection of running coupling?
