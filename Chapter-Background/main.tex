...
There is a sign of rapidity-dependent jet suppression in central \pPb collisions \cite{HION-2013-08}, although this is not a smoking gun for any medium formation because \RpPb is sensitive to other production effects like differences in the nuclear \ac{PDF}.
...
%% \subsection{Flow in small systems} %% no separate section for experimental results, possibly in theory?
 review of small-systems hydro: \cite{Nagle:2018nvi}
\todo{discuss results for \pp and \pPb flow}
...
\cite{Weller:2017tsr} %% simultaneous pp, pPb, PbPb
