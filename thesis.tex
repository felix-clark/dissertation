...
\newcommand{\thesisTitle}{Femtoscopy in $\sqrt{s_\mathrm{NN}} = 5.02~\TeV$ proton-lead collisions with the ATLAS detector at the Large Hadron Collider}
\newcommand{\myName}{Michael R. Clark}
\newcommand{\abstractText}{
abstract text here
}
\newcommand{\yearText}{2017}
